(function () {
    ...
    .controller('calendarCtrl', ["$scope", "$state", "$ionicModal", "$ionicListDelegate", "myappService", function ($scope, $state, $ionicModal, $ionicListDelegate, myappService) {
    
        //refresh binding
        $scope.refresh = function () {
            //make call to service
            myappService.wait(true);
            myappService.getCalendars(function (calendarItems) {
