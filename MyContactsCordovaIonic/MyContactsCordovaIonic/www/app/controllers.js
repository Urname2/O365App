(function () {
    ...
    .controller('speakerCtrl', ["$scope", "$state", "$ionicModal", "$ionicListDelegate", "myappService", function ($scope, $state, $ionicModal, $ionicListDelegate, myappService) {
    
        //refresh binding
        $scope.refresh = function () {
            //make call to service
            myappService.wait(true);
            myappService.getSpeakers(function (speakers) {
